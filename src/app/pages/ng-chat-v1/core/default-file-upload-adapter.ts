...
export class DefaultFileUploadAdapter implements IFileUploadAdapter
{
     ...
     */
    constructor(private _serverEndpointUrl: string, userId: string, private _http: HttpClient) {
    }

    uploadFile(file: File, participantId: any, userId): Observable<Message> {
        ...
        return this._http.post<Message>(this._serverEndpointUrl, formData, { headers: headers});
